...
var Roomprint = React.createClass({
  ...
  handleSubmit: function handleSubmit(e) {
    e.preventDefault();
    this.props.onRoomChange(this.state.searchQuery.trim()); // Update currentRoom with the submitted room
...
var WebsiteWrapper = React.createClass({
  displayName: 'WebsiteWrapper',

  getInitialState: function getInitialState() {
    return {
      currentRoom: 'main' // Initialize currentRoom in WebsiteWrapper
    };
  },

  handleRoomChange: function handleRoomChange(room) {
    this.setState({ currentRoom: room }); // Function to update currentRoom
  },
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(Roomprint, { onRoomChange: this.handleRoomChange })
        ),
        React.createElement(
          'div',
          { className: 'center-content' },
          React.createElement(_appJsx2['default'], { currentRoom: this.state.currentRoom })
        )
      )
    );
  }
...
React.render(React.createElement(WebsiteWrapper, null), document.getElementById('app'));

},{"./app.jsx":2,"react":158}],2:[function(require,module,exports){
'use strict';
...
var ChatApp = React.createClass({
	...
	getInitialState: function getInitialState() {
		return { users: [], messages: [], text: '', currentRoom: 'main' };
	},
	...
	_initialize: function _initialize(data) {
		...
		this.setState({ users: users, user: name, room: room });
	},
